...
from examples.co_delfos_productos_srf_transformar_remittances_order_status import metadata

_DOMAIN: str = "productos"
_SUBDOMAIN: str = "srf"
_EXPODY_NAME: str = "interno_expody"
_PREFIX_NAME: str = "dynamodb"
_DATA_PRODUCT: str = "remittances_order_status"
_CAPACITY: str = "delfos"
_COUNTRY_MESH: str = "co"
_COUNTRY_CLAN: str = "co"
_CATALOG_NAME: str = "table-catalog"
_INSERT_MODE: str = "append"
_PRIMARY_KEY: str = ["orderId", "remittanceId"]
_PRECOMBINE_KEY: str = "creation_date"
_METADATA_MODULE = metadata
_PARTITION_FIELD: str = "creation_date_tstamp"
_PACKAGE_NAME = "co_delfos_productos_srf_transformar_remittances_order_status"
